...
#
#     PHX_SERVER=true bin/atlas_web start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :atlas_web, AtlasWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :atlas_web, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
if config_env() == :prod do
  ...
  # Absolute path here; resolver below treats absolute paths as-is.
